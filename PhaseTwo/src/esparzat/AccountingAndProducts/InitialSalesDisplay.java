 ...
 * add, remove, or exit. Based on their selection it takes them to classes that
...
public class InitialSalesDisplay {
	 ...
	 * display. It will route to the next method to complete that action based
	 * on their choice.
	 */

	public static void initialDisplay() {
		System.out
				.print("Would you like to do: Add Sale (Add), Remove Sale (Remove), Finish Sale (Finish), "
