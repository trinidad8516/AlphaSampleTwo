...
/**
 * This class contains the getters, setters, and constructors for the attributes
 * of a product. This was created in class as a group.
 */
...
public class Product {
	...
	public Product(String upc, String description, BigDecimal price,
			int quantity, int numInStock) {
		this.upc = upc;
	 ...
	 * 
	 * @param upc
	 *            This is the upc of the product.
	 */
	 ...
	 * 
	 * @param quantity
	 *            This is the quantity a customer wants to purchase.
	 */
	...
	public String toString() {
		...
		return "|" + description + "    |" + nf.format(price) + " x "
				+ quantity + " = "
				+ nf.format(price.multiply(BigDecimal.valueOf(quantity))) + "|";
	}

	/**
	 * This is the override method that checks whether or not a product is
	 * equal.
	 * 
	 * @return boolean true
	 */
