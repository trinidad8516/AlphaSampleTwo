package esparzat.AccountingAndProducts;

import java.io.*;
import java.math.BigDecimal;
import java.util.Scanner;

import esparzat.Personnel.ManagersDisplay;

/**
 * This class contains method to check if the productsandinventory.txt file
 * exists, the add and remove product method for the manager function to use.
 */
...
public class ProductAndInventoryDisplay {
	...
	/**
	 * This method checks to see if the ProductsAndInventory.txt file exists and
	...
	/**
	 * This method will allow a manager to add a new product. After they enter
	 * in the answers based on the prompts it will write the new product to the
	 * file. It will also catch the exception if the file is not found.
	 */
	...
	public static void addNewProduct() {
		...
		try {
			...
			while (choice.equalsIgnoreCase("y")) {
				...
				BigDecimal price = BigDecimal.valueOf(Double.parseDouble(sc
						.nextLine()));

				System.out
						.print("What is the number in stock of the product? ");
	...
	/**
	 * This method allow a manager to remove a product completely from the
	 * ProductsAndInventory.txt file.
	 */
	...
	public static void removeProduct() {
		...
		try {
			...
			while (choice.equalsIgnoreCase("y")) {
				System.out
						.print("What is the upc of the product you would like to remove? ");
				String upc = sc.nextLine();
				Boolean found = false;
				...
				if (!found) {
					...
					pw.close();
					System.out
							.print("Would you like to remove another product? Y or N ");
					choice = sc.nextLine();
